...
const deleteProducts = require('./controllers/Routes/DELETEproducts.controller');
const deleteSales = require('./controllers/Routes/DELETEsales.controller');
